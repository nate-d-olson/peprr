...
```{r echo = FALSE, fig.align='center', fig.show = 'asis', fig.cap= "Comparison of base purity values for PGM and MiSeq."}
...
```{r echo = FALSE, fig.align='center', fig.show = 'asis', fig.cap= "Bias metrics for low purity positions."}
low_pur_metrics_figure(db_con)
```
...
#### Genomic Purity
```{r echo = FALSE,child='rm_specific_genomic_purity_summary.Rmd' }
...
contam_heatmap_figure (peprDB, rm_genus)
```
...
__%%TODO%%__ DNA fragment stability results
